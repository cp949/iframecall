...
| [TRP-0004-ready-lost-before-host-subscribe.md](TRP-0004-ready-lost-before-host-subscribe.md)                       | iframe이 host 구독 전에 ready를 보내면 유실되고 controller가 영구 `pending`. ready-query로 해결                                      |
